  ...
  return (
    <div className="glass-card rounded-lg p-5">
                ...
                <div className="space-y-2">
                  {categories.map(category => {
                    const aqiCategoryInfo = getAQICategory(
                      category === 'Good' ? 10 :
                      category === 'Moderate' ? 25 :
                      category === 'Unhealthy for Sensitive Groups' ? 45 :
                      category === 'Unhealthy' ? 100 :
                      category === 'Very Unhealthy' ? 200 : 300
                    );
      ...
      <div className="mt-4 text-sm text-muted-foreground">
        Showing {sortedSensors.length} of {sensors.length} sensors
      </div>
    </div>
  );
};
