      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground mt-3 max-w-2xl mx-auto">
            ...
            Click on a sensor to view detailed information.
          </p>
        </div>
        
        <div className="relative w-full h-[500px] rounded-xl shadow-sm overflow-hidden bg-gray-100">
          ...
          <div className="absolute inset-0 bg-blue-50 flex items-center justify-center">
            ...
            {selectedSensorData && (
              <div 
                className="absolute glass-card rounded-lg shadow-lg p-4 w-64 z-20 transition-all duration-300 animate-fade-in"
                style={{ 
            ...
            <div className="absolute bottom-4 right-4 glass-card px-4 py-3 rounded-lg text-sm">
        ...
        <div className="text-center mt-4 text-sm text-muted-foreground">
          Note: This is a simplified map visualization. In production, we would integrate with Google Maps or Leaflet.
        </div>
      </div>
    </section>
  );
